...
export const translations = {
  it: {
    ...
    dayspa: {
      ...
      prezzi: [
        { nome: "Ingresso Giornaliero", sub: "Piscine & Grotte Termali", tariffe: [{ quando: "Feriale", prezzo: "35" }, { quando: "Weekend e festivi", prezzo: "45" }] },
        { nome: "Ingresso Serale", sub: "Ven. e Sab. · 18:00–22:30", nota: "Percorso Spa + area relax", tariffe: [{ quando: "", prezzo: "29" }] },
        { nome: "Abbonamento", sub: "10 ingressi a persona", tariffe: [{ quando: "Feriale", prezzo: "300" }, { quando: "Tutti i giorni", prezzo: "400" }] },
      ],
    ...
    booking: {
      ...
      golfConv: "Convenzionati con tre circoli a pochi minuti: Montecchia, Golf Club Padova e Frassanelle. Prenotiamo noi la partenza — e il taxi per arrivarci. Le lezioni col maestro si tengono invece sul nostro campo pratica, accanto all’hotel.", ctaGreen: "Richiedi un green fee", ctaMaestro: "Lezione col maestro", ctaSpa: "Richiedi un trattamento", err_generic: "Si è verificato un errore. Riprova tra poco.",
  ...
  en: {
    ...
    dining: {
      ...
      hours: [
        ...
        { t: "Bistrot — Bar", d: "10:00 am – 11:00 pm" },
      ],
      bistroTitle: "Bistrot La Piazza",
    ...
    dayspa: {
      ...
      prezzi: [
        { nome: "Daily Entry", sub: "Thermal Pools & Grottoes", tariffe: [{ quando: "Weekdays", prezzo: "35" }, { quando: "Weekends & holidays", prezzo: "45" }] },
        { nome: "Evening Entry", sub: "Fri & Sat · 18:00–22:30", nota: "Spa path + relax area", tariffe: [{ quando: "", prezzo: "29" }] },
        { nome: "Season Pass", sub: "10 entries per person", tariffe: [{ quando: "Weekdays", prezzo: "300" }, { quando: "Any day", prezzo: "400" }] },
      ],
    ...
    booking: {
      ...
      golfConv: "We work with three clubs a few minutes away: Montecchia, Golf Club Padova and Frassanelle. We book the tee time — and the taxi to get there. Lessons with our pro, instead, take place on our own driving range next to the hotel.", ctaGreen: "Request a green fee", ctaMaestro: "Lesson with the pro", ctaSpa: "Request a treatment", err_generic: "An error occurred. Please try again shortly.",
  ...
  de: {
    ...
    dining: {
      ...
      hours: [
        ...
        { t: "Bistrot — Bar", d: "10:00 – 23:00 Uhr" },
      ],
      bistroTitle: "Bistrot La Piazza",
    ...
    dayspa: {
      ...
      prezzi: [
        { nome: "Tageseintritt", sub: "Thermalbäder & Grotten", tariffe: [{ quando: "Werktags", prezzo: "35" }, { quando: "Wochenende & Feiertage", prezzo: "45" }] },
        { nome: "Abendeintritt", sub: "Fr & Sa · 18:00–22:30", nota: "Spa-Rundgang + Ruhebereich", tariffe: [{ quando: "", prezzo: "29" }] },
        { nome: "Saisonkarte", sub: "10 Eintritte pro Person", tariffe: [{ quando: "Werktags", prezzo: "300" }, { quando: "Täglich", prezzo: "400" }] },
      ],
    ...
    booking: {
      ...
      golfConv: "Wir arbeiten mit drei Clubs in wenigen Minuten Entfernung: Montecchia, Golf Club Padova und Frassanelle. Wir buchen die Startzeit — und das Taxi dorthin. Die Golfstunden hingegen finden auf unserer eigenen Driving Range direkt am Hotel statt.", ctaGreen: "Green Fee anfragen", ctaMaestro: "Stunde mit dem Pro", ctaSpa: "Anwendung anfragen", err_generic: "Ein Fehler ist aufgetreten. Bitte versuchen Sie es gleich erneut.",
  ...
  fr: {
    ...
    dayspa: {
      ...
      prezzi: [
        { nome: "Entrée Journée", sub: "Piscines & Grottes Thermales", tariffe: [{ quando: "En semaine", prezzo: "35" }, { quando: "Week-end et jours fériés", prezzo: "45" }] },
        { nome: "Entrée Soirée", sub: "Ven. et Sam. · 18h00–22h30", nota: "Parcours Spa + espace détente", tariffe: [{ quando: "", prezzo: "29" }] },
        { nome: "Abonnement", sub: "10 entrées par personne", tariffe: [{ quando: "En semaine", prezzo: "300" }, { quando: "Tous les jours", prezzo: "400" }] },
      ],
